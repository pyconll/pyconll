...
class mapping[K, V](FieldDescriptor):
    ...
    ordering_key: Optional[FieldDescriptor | Callable[[K], SupportsRichComparisonT]] = field(
...
class array_tuple[*Ts](FieldDescriptor):
    delimiter: str
    el_mapper: Optional[FieldDescriptor | Callable[[int, str], Union[Unpack[*Ts]]]] = field(
        default=None, kw_only=True
    )
