...
class Parser:
    """
    Parser for CoNLL-U formatted data.

    This class provides methods to parse CoNLL-U data from various sources
    including strings, files, and generic iterables. It can either load the
    entire data structure into memory or provide streaming iteration for
    memory-efficient processing of large datasets.
    """

    def load_from_string(self, source: str) -> Conll:
        """
    ...
    def load_from_file(self, file_descriptor: PathLike) -> Conll:
        """
    ...
    def load_from_resource(self, resource: Iterable[str]) -> Conll:
        """
    ...
    def iter_from_resource(self,
                           resource: Iterable[str]) -> Iterator[Sentence]:
        """
...
def get_default_parser() -> Parser:
    ...
    Returns:
        The default Parser instance used for module-level operations.
    """
