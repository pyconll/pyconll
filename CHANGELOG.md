...
## [4.0.0] - YYYY-MM-DD
### Changed
- To support latest Python type hint syntax, move minimum supported version up to 3.14+ for new features.
...
## [3.3.0] - 2025-10-11
### Changed
- Moved official Python support up to 3.10 to keep in line with current LTS versions.
- Improved type hints to use newer syntax.
