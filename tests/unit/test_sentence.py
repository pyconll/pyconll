...
def test_new_pardoc_comment_parsing():
    """
    Test that the id keyword does not inappropriately trigger an id association.
    """
    source = (
        '# newpar id\n'
        '# sent_id = fr-ud-dev_00002\n'
    ...
    assert sentence.par_id is None
...
def _assert_tree_structure(sentence, tree, root_token, children_paths):
    """
...
def test_to_tree_standard_sentence():
    ...
    _assert_tree_structure(sentence, st, sentence[2], {
        (0, ): 0,
        (1, ): 1,
        (2, ): 3
    })
