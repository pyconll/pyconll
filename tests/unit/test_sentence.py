...
def test_simple_sentence_construction():
    ...
    assert_token_members(sentence["1"], "1", "Mais", "mais", "CCONJ", None, {}, "3", "cc", {}, {})
    assert_token_members(
        sentence["2"], "2", "comment", "comment", "ADV", None, {}, "3", "advmod", {}, {}
    )
    assert_token_members(
        sentence["3"],
        "3",
    ...
    assert_token_members(sentence["4"], "4", "?", "?", "PUNCT", None, {}, "3", "punct", {}, {})
...
def test_str_indexing():
    ...
    assert_token_members(
        ...
        "NOUN",
        None,
        {"Gender": set(("Masc",)), "Number": set(("Sing",))},
        "9",
        "nsubj",
        {},
        {},
...
def test_int_slice_indexing():
    ...
    assert_token_members(
        test_tokens[2], "10", "donc", "donc", "ADV", None, {}, "9", "advmod", {}, {}
    )
...
def test_int_slice_indexing_missing_value_start():
    ...
    assert_token_members(
        ...
        "NOUN",
        None,
        {"Gender": set(("Fem",)), "Number": set(("Plur",))},
        "3",
        "nsubj",
        {},
        {},
...
def test_int_slice_indexing_missing_value_stop():
    ...
    assert_token_members(
        ...
        "DET",
        None,
        {"Definite": set(("Def",)), "Number": set(("Plur",)), "PronType": set(("Art",))},
        "13",
        "det",
        {},
        {},
    ...
    assert_token_members(test_tokens[3], "14", ".", ".", "PUNCT", None, {}, "3", "punct", {}, {})
...
def test_to_tree_standard_sentence():
    ...
    assert_tree_structure(
        st, {(): sentence[2], (0,): sentence[0], (1,): sentence[1], (2,): sentence[3]}
    )
...
def test_to_tree_empty_node_exception():
    ...
    assert_tree_structure(
        st, {(): sentence[2], (0,): sentence[0], (1,): sentence[1], (2,): sentence[4]}
    )
